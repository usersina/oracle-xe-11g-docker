...
@/u01/app/oracle/db-sample-schemas/product_media/pm_cre.sql   -- create objects
@/u01/app/oracle/db-sample-schemas/product_media/pm_p_ord.sql -- load ORDSYS types

REM =======================================================
REM use sqlldr to populate PRINT_MEDIA and its nested table
REM =======================================================
 
@/u01/app/oracle/db-sample-schemas/product_media/pm_p_lob &pass &data_path &log_path &work_path &connect_string

REM =======================================================
REM finish
REM =======================================================

@/u01/app/oracle/db-sample-schemas/product_media/pm_analz -- gather statistics 
