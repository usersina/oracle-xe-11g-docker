...
CREATE OR REPLACE DIRECTORY data_file_dir AS '/u01/app/oracle/db-sample-schemas/sales_history/'; 
CREATE OR REPLACE DIRECTORY log_file_dir  AS '/u01/app/oracle/db-sample-schemas/log/'; 
CREATE OR REPLACE DIRECTORY media_dir     AS '/u01/app/oracle/db-sample-schemas/product_media/';
